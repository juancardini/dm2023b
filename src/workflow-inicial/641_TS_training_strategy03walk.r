# Experimentos Colaborativos Walk Forward
...
PARAM <- list()
PARAM$experimento <- "TS6413"

PARAM$exp_input <- "FE6313"
...
PARAM$final_train <-c(
   202011, 202010, 202009, 202008,202007,202003, 202002, 202001, 201912,
  201911, 201910, 201909, 201908, 201907,201906,201905,201904,201903
)

PARAM$train$training <- c(
  202010, 202009, 202008,202007,202003, 202002, 202001, 201912, 201911,
  201910, 201909, 201908, 201907, 201906, 201905,201904,201903,201902
)

PARAM$train$validation <- c(202102)
PARAM$train$testing <- c(202104,202103)
...
PARAM$train$semilla <- 532575 # cambiar por su propia semilla  !!!
