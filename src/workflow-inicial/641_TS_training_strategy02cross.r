# Experimentos Colaborativos Cross Validation
...
PARAM <- list()
PARAM$experimento <- "TS6412"

PARAM$exp_input <- "FE6312"
...
PARAM$final_train <-c(
  ...
  202101, 202012, 202011, 202010, 202009, 202008,202007, 202002, 202001, 201912,
  201911, 201910, 201909, 201908
)

PARAM$train$training <- c(
  202012, 202011, 202010, 202009, 202008,202007, 202002, 202001, 201912, 201911,
