...
# Workflow  Feature Engineering historico BORUTA
...
PARAM <- list()
PARAM$experimento <- "FE6315"

PARAM$exp_input <- "DR7215"
...
PARAM$Boruta$seed <- 800161 # cambiar por la propia semilla
PARAM$Boruta$train_from <- 202101
PARAM$Boruta$train_to <- 202101
PARAM$Boruta$max_runs <- 100
